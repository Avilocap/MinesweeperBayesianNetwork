...
#Introducir aquí (anchura, altura, número de minas)
game = MSGame(10, 10, 10)

#Generamos el modelo
modelo = gameNetworkGenerator(game)
#Hacemos un click aleatorio en el tablero para comenzar a obtener valores de eviencias de las casillas.
print("")
print("△ Tablero ------------------------------------------------------")
print("")
game.print_board()
